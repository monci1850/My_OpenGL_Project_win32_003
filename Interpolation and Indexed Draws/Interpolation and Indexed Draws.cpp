/* This project is to test the interpolation and indexed draws. 
* We will try to draw a pyramid without projection.
* Q:?
*/
#include <stdio.h>
#include <string.h>
...
// Add IBO/EBO index buffer object or element buffer object
GLuint VertexBufferOjbect, VertexArrayObject, IndexBufferObject, shader, uniformModelMatrix;
